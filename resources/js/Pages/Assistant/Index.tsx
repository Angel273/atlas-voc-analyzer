        ...
        <ReactMarkdown
            ...
            components={{
                ...
                code: ({ className, children }: any) => {
                    ...
                    return isInline ? (
                        <code className="bg-[#dce4d8]/60 px-1.5 py-0.5 rounded text-[11px] font-mono text-[#18221d]">
                            {children}
                        </code>
                    ) : (
                        <pre className="bg-[#18221d] text-white p-3 my-2.5 overflow-x-auto text-[11px] font-mono rounded-none">
                            <code>{children}</code>
                        </pre>
                    );
                },
