...
<head>
    ...
    <title inertia>{{ config('app.name', 'ATLAS VOC Analysis') }}</title>
    ...
    <script>
        (function () {
            try {
                var saved = localStorage.getItem('atlas_theme') || localStorage.getItem('theme');
...
<body class="bg-[#f7f6f1] text-[#18221d] antialiased min-h-screen">
    @inertia
</body>
</html>
